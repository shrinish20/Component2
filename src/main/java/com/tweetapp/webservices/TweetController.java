...
public class TweetController {
	...
	public ResponseEntity<CustomResponse> getUserTweets(
			@PathVariable(name = "loginId", required = true) String loginId) {
	...
	public ResponseEntity<CustomResponse> postTweet(@PathVariable(name = "loginId", required = true) String loginId,
	...
	public ResponseEntity<CustomResponse> updateTweet(@PathVariable(name = "loginId", required = true) String loginId,
			@PathVariable(name = "id", required = true) String id, @RequestBody Tweet tweet) {
	...
	public ResponseEntity<CustomResponse> deleteTweet(@PathVariable(name = "loginId", required = true) String loginId,
	...
	public ResponseEntity<CustomResponse> likeTweet(@PathVariable(name = "loginId", required = true) String loginId,
			@PathVariable(name = "id", required = true) String id, @RequestParam(required = true) boolean isLiked) {
		LOGGER.info("Entering likeTweet() API :::: {}");
		CustomResponse response;
		String result = tweetService.likeTweet(id, isLiked);
		if ("Success".equalsIgnoreCase(result)) {
			response = new CustomResponse(HttpStatus.ACCEPTED, ((isLiked)?TweetConstant.TWEET_LIKED:TweetConstant.TWEET_DISLIKED), LocalDateTime.now());
		} else {
	...
	public ResponseEntity<CustomResponse> replyTweet(@PathVariable(name = "loginId", required = true) String loginId,
			@PathVariable(name = "id", required = true) String id, @RequestBody TweetReply reply) {
